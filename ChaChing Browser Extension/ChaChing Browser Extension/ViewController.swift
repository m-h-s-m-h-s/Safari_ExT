...
let extensionBundleIdentifier = "com.MHS.ChaChing-Browser-Extension.Extension"
...
class ViewController: NSViewController {
    ...
    override func viewDidLoad() {
        ...
        // Create title label
        let titleLabel = NSTextField(labelWithString: "ChaChing Browser Extension")
    ...
    private func createInstructionsView() -> NSView {
        ...
        let step2Text = createStepText("2. Check the box next to ChaChing Browser Extension")
